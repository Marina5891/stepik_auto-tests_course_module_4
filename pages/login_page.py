...
class LoginPage(BasePage):
    ...
    def should_be_login_url(self):
        # проверка на корректный url адрес страницы авторизации
        assert "login" in self.browser.current_url, "Login url not found"
